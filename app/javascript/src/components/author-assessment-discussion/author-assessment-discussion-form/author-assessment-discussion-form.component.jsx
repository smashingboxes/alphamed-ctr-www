...
import {
  ButtonContainer
} from './author-assessment-discussion-form.styles'
...
class AuthorAssessmentDiscussionForm extends React.Component {
        ...
        <form onSubmit={this.handleSubmit}>
          <GenericFormContainer>
            ...
            <GenericFieldContainer>
              ...
              <FormEditor
                  require={true}
                  label='Reference (Examples available here)'
                  setData={(value) => {}}
                />
              </GenericFieldContainer>
...
export default AuthorAssessmentDiscussionForm;
